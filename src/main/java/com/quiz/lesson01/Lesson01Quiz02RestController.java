...
public class Lesson01Quiz02RestController {
	...
	// 1. URL : http://localhost/lesson01/quiz02/1
	@RequestMapping("/1")
	public List<Map<String, Object>> quiz02_1() {
		...
		return list; // list<Map<String, Object>> JSON 응답
	}
	
	// 2. URL : http://localhost/lesson01/quiz02/2
	@RequestMapping("/2")
	public List<Board> quiz02_2() {
		...
		return list; // list<Board> JSON 응답
	}
	
	// 3. URL : http://localhost/lesson01/quiz02/3
	@RequestMapping("/3")
